...
<form action="<?=POST_FORM_ACTION_URI?>#feedback" method="post" class="form-horizontal form-style-dashed">
	...
	{
		foreach ($arResult['ERROR_MESSAGE'] as $e) {
			ShowError($e);
		}
	}
	...
	<div class="row">
		<div class="col-lg-8 col-md-8">
			...
			<div class="form-group">
				<label for="input-10" class="col-sm-4 col-xs-12 control-label" <?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("MESSAGE", $arParams["REQUIRED_FIELDS"])):?>required<?endif?>></label>
